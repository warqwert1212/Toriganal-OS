...
static void cmd_help(void) {
    ...
    io_put_string("desktop - placeholder; no GUI is implemented yet | touch <path> - create an empty file\n");
    io_put_string("settings [480p|720p] - change the UI resolution  | mkdir <path> - create a directory   \n");
    io_put_string("trpbuild <folder> - build a .trp from a folder   | ls [path] - list directory contents \n");

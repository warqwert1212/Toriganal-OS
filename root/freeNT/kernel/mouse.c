...
/* ── Development stubs: inb/outb are x86 port I/O ─────────────────────────
   On bare-metal freeNT, these are defined in the kernel (asm or via GCC
   builtins). On Codespaces, stub them to prevent link errors.
   ────────────────────────────────────────────────────────────────────── */

#ifdef __GLIBC__
/* Codespaces: stub these out */
